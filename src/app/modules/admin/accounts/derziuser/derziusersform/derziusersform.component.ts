...
@Component({
  selector: 'app-derziusersform',
  imports: [MATERIAL_IMPORTS],   // ✅ just one line
  templateUrl: './derziusersform.component.html',
  styleUrl: './derziusersform.component.scss'
})
export class DerziUsersformComponent {
  ...
  userDetails: any;
  roles: any[] = [];
  constructor(private _router: Router,private fb: FormBuilder,private route: ActivatedRoute,private _masterservice: AuthService,private _toastrService: ToastService) {}
  ...
  ngOnInit(): void {
    ...
    this._masterservice.getAllRoles(this.usertoken).subscribe(res => this.roles = res.data.docs);
    ...
    this.userform = this.fb.group({
      ...
      roleId: ['', Validators.required],  // multiple select
  ...
  saveData(data: any): Observable<any> {
    ...
    return this._masterservice.createUser(payload, this.usertoken).pipe(
      tap(res => {
        ...
        this._router.navigate(['/derziuser']);
      }),
      catchError(err => {
