...
export class PageService {
  ...
  public getAllPage(usertoken: any, page:any, size:any) {
    return this._httpReqService.request({
      method: APP_CONSTANTS.API_METHODS.GET,
      url: `${this._configService.getApiUrl()}${environment.SERVICE_APIS.GET_ALL_PAGE}?page=${page}&size=${size}`,
  ...
  public getSpecificPage(editId: string, usertoken: string) {
    return this._httpReqService.request({
      method: APP_CONSTANTS.API_METHODS.GET,
      url: this._configService.getApiUrl()+environment.SERVICE_APIS.SPECIFIC_PAGE+ '/' + editId,
      headerConfig: { token: usertoken }
    }).pipe(
  ...
  public createPage(payload,usertoken) {
    ...
    return this._httpReqService.request({
      ...
      url: this._configService.getApiUrl()+environment.SERVICE_APIS.ADD_PAGE,
      body: payload,
      headerConfig: {token:usertoken}
    })
      .pipe(
  ...
  public updatePage(editId,requestBody:any,usertoken:any) {

    //console.log("Api",requestBody);

    const url = this._configService.getApiUrl()+environment.SERVICE_APIS.UPDATE_PAGE+ '/' + editId;
    return this._httpReqService.request({
  ...
  public deletePage(deleteId,usertoken) {


    return this._httpReqService.request({
      method: APP_CONSTANTS.API_METHODS.DELETE,
      url: this._configService.getApiUrl()+environment.SERVICE_APIS.DELETE_PAGE+ '/' + deleteId,
      headerConfig: {token:usertoken}
    })
      .pipe(
        map(response => this._extractResponse(response))
